...
from library.anima_runtime.config_adapter import apply_root_anima_config_if_needed, normalize_optimizer_aliases
...
class AnimaNetworkTrainer(train_network.NetworkTrainer):
    ...
    def get_tokenize_strategy(self, args):
        ...
        self.t5_tokenizer = load_anima_t5_tokenizer(args.t5_tokenizer_dir)
...
def setup_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--config", type=str, default="", help="Root-style Anima trainer TOML config.")
